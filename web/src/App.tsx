        ...
        <div className="app">
            <div className="hero">
                ...
                <div className="hero-card">
                    <h2>示例输入</h2>
                    <button
                        onClick={() => handleExample("最近咳嗽发烧胸闷，应该挂什么科？")}
                        type="button"
                    >
                        咳嗽发烧胸闷
                    </button>
                    <button
                        onClick={() => handleExample("关节反复疼痛肿胀，晨僵明显")}
                        type="button"
                    >
                        关节疼痛晨僵
                    </button>
                    <button
                        onClick={() => handleExample("腹痛伴恶心，食欲下降")}
                        type="button"
                    >
                        腹痛恶心
                    </button>
            ...
            <div className="result">
                ...
                {qwenResult && mode === "qwen" && (
                    <div className="result-grid">
                        <div className="result-card">
                            <h3>推荐科室</h3>
                            <div className="dept">{qwenResult.department || "未解析"}</div>
                            <div className="confidence">
